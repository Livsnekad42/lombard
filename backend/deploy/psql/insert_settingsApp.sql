...
('processingPercent', 'Процент процессинга %', '-', '1', '1', '0'),
('probePrice_585', 'Стоимость 585 пробы за один грамм', '10500', '1', '1', '1'),
('probePrice_750', 'Стоимость 750 пробы за один грамм', '13461', '1', '1', '1');

INSERT INTO public.contents ("componentName", content, "enable") VALUES
('prolongationState_disabled', 'Извините!В данный момент этот функционал не работает.', '1');
